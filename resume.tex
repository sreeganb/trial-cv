...
%\cvitem{1}{Molecular interactions.}
%\cvitem{2}{Reaction dynamics.}
%\cvitem{3}{Algorithms for quantum chemical calculations.}
%\cvitem{}{}
%\subsection{Broad Research Area: Theoretical chemistry}
\cvlistitem{Implemented the COSMO continuum solvation model within the random phase approximation (RPA) in the TURBOMOLE quantum chemistry program package.}
\cvlistitem{Developed and implemented static dipole polarizabilities within the generalized Kohn-Sham RPA.}
\cvlistitem{Collaborated with experimentalists to calculate the electronic structure and dynamics of lanthanide complexes, solvated organic acids as well as enzyme
catalysis reactions.}
...
\cvitem{5}{\underline{S. G. Balasubramani}, et al., TURBOMOLE: Modular program suite for ab initio quantum-chemical and condensed-matter simulations,
